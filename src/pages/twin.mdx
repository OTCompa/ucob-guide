...
import ExtraDetails from '@/components/mdx/ExtraDetails.astro'
...
## TODO
- Add Generate + Twister combo explanation
...
### Neurolink
Small puddle that is dropped under the center of Twintania's hitbox
...
#### Plummet
Conal physical mini-tankbuster aimed at the player that is
highest in aggro, no cast bar  


<ImageWrapperSquare img={twister} alt="Twister" classdiv="mt-8"/>

#### Twister
Drops small tornadoes (Twisters) under 4 players near the end of the cast  
...
#### Fireball
Targeted party stack on marked player  
...
#### Death Sentence
Tankbuster (Forced tankswap) which inflicts
...
#### Liquid Hells
A set of 5x puddles, baited sequentially on the targeted player  
...
#### Generate
Marks 1-3 players for an orb (Hatch) that follows the location of the player till the orb is intercepted  
  *In this phase*, only DPS players can
  ...
  <ExtraDetails summary="Hatches need to be intercepted by a player within a Neurolink puddle.">
      ...
      for 16 seconds which makes any Hatches lethal during its duration even with the
      <Status name="Neurolink" img={neurolink} /> debuff.   
...
#### Liquid Hells (random)
Same as Liquid Hells, but instead of a person past
